...
export default defineConfig({
    entry: {
        ...
        'adapters/framework/express': 'src/adapters/framework/express.ts',
        'adapters/framework/fastify': 'src/adapters/framework/fastify.ts',
        'adapters/framework/hono': 'src/adapters/framework/hono.ts',
        ...
        toolkits: 'src/toolkits/index.ts',
