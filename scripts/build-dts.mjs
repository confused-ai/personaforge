...
const entries = [
  ...
  ['src/harness/index.ts',              'dist/harness.d.ts'],
  ['src/system/index.ts',               'dist/system.d.ts'],
  ['src/hooks/index.ts',                'dist/hooks.d.ts'],
  ['src/events/index.ts',               'dist/events.d.ts'],
  ['src/registry/index.ts',             'dist/registry.d.ts'],
  ['src/adapters/framework/express.ts', 'dist/adapters/framework/express.d.ts'],
  ['src/adapters/framework/fastify.ts', 'dist/adapters/framework/fastify.d.ts'],
  ['src/adapters/framework/hono.ts',    'dist/adapters/framework/hono.d.ts'],
  ['src/runnable/index.ts',             'dist/runnable.d.ts'],
  ['src/parsers/index.ts',              'dist/parsers.d.ts'],
  ['src/structured/index.ts',           'dist/structured.d.ts'],
  ['src/streaming/index.ts',            'dist/streaming.d.ts'],
  ['src/checkpoint/index.ts',           'dist/checkpoint.d.ts'],
  ['src/toolkits/index.ts',             'dist/toolkits.d.ts'],
  ['src/control-plane/index.ts',        'dist/control-plane.d.ts'],
  ['src/gateway/index.ts',              'dist/gateway.d.ts'],
  ['src/processors/index.ts',           'dist/processors.d.ts'],
  ['src/durable/index.ts',              'dist/durable.d.ts'],
  ['src/goals/index.ts',                'dist/goals.d.ts'],
  ['src/code-mode/index.ts',            'dist/code-mode.d.ts'],
  ['src/approval/index.ts',             'dist/approval.d.ts'],
];
